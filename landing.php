...
<div class="container" id="col-adm">
    ...
    <div class="college-gallery">
        <div><img src="public/assets/img/gallery/col1.png" data-image-hd="public/assets/img/col-adm-imgs/1-admission-scaled.jpg"
                alt="Step 1" onclick="showHdImage(this.getAttribute('data-image-hd'), this.alt);">
        </div>
        <div><img src="public/assets/img/gallery/col2.png" data-image-hd="public/assets/img/col-adm-imgs/2-admission-scaled.jpg"
                alt="Step 2" onclick="showHdImage(this.getAttribute('data-image-hd'), this.alt);">
        </div>
        <div><img src="public/assets/img/gallery/col3.png" data-image-hd="public/assets/img/col-adm-imgs/3-admission-scaled.jpg"
                alt="Step 3" onclick="showHdImage(this.getAttribute('data-image-hd'), this.alt);">
        </div>
        <div><img src="public/assets/img/gallery/col4.png" data-image-hd="public/assets/img/col-adm-imgs/4-admission-scaled.jpg"
                alt="Step 4" onclick="showHdImage(this.getAttribute('data-image-hd'), this.alt);">
        </div>
        <div><img src="public/assets/img/gallery/col5.png" data-image-hd="public/assets/img/col-adm-imgs/5-admission-scaled.jpg"
                alt="Step 5" onclick="showHdImage(this.getAttribute('data-image-hd'), this.alt);">
        </div>
        <div><img src="public/assets/img/gallery/col6.png" data-image-hd="public/assets/img/col-adm-imgs/6-admission-scaled.jpg"
                alt="Step 6" onclick="showHdImage(this.getAttribute('data-image-hd'), this.alt);">
        </div>
        <div><img src="public/assets/img/gallery/col7.png" data-image-hd="public/assets/img/col-adm-imgs/7-admission-scaled.jpg" 
