        ...
        <form method="get" onsubmit="handleSubmit(event)">
            ...
            <div class="search-wrapper">
                ...
                <div class="input-holder">
                    <input type="text" class="search-input" name="search_input" placeholder="Search Ref# for OJT admission. Ex: 001" required />
...
$query = "SELECT * FROM ojtapplicants WHERE RIGHT(ID, 2) = '$last_two_digits'";
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $searchResult .= "<p>Status: <span style='color: $statusColor;'>" . $row["Status"] . "</span></p>";
