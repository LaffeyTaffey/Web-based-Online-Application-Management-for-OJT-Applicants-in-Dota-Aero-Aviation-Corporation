    ...
    <tr>
      ...
      while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
        ...
        <tr>
            ...
            <td>
                <p class="text-xs font-weight-bold mb-0">' . $row['ID'] . '</p> <br>
    ...
    <div class="col-md-8">
      <div class="card animate__animated animate__fadeIn">
        ...
        <div class="card-body text-center">
          ...
          $query = "SELECT ID, Picture FROM ojtapplicants WHERE ID = '$admin_id'";
          $result = mysqli_query($dbcon, $query);
          ...
          if ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<p class="text-muted">Welcome, ' . (isset($_SESSION['ID']) ? $_SESSION['ID'] : 'Unknown') . '! You are logged in.</p>';
            echo '</div>';
