                ...
                <div class="box-login">
                    <div class="fieldset-body" id="login_form">
                        ...
                        <p class="field">
                            ...
                            <input type="text" id="user" name="user" title="Reference-Number" required placeholder="Enter Ref# Ex: ADM1" />
                        ...
                        <a href="public/material-dashboard-master/index.php"><input type="submit" id="do_login" value="Login Now" title="Login" /></a>
                    </div>
                </div>
            </div>
            <div class="box-info">
                ...
                <a href="forgot-password.php"><button onclick="" class="b-support" title="Forgot Password?"> Forgot
                        Password?</button></a>
            </div>
        </div>
        <br>
