        ...
        <div id="regforms">
            ...
            <div class="tab">
                <div id="guideline_file">
                    <div id="guidebox"><p id="guide"> <b>Upload File Guidelines:</b>
                        <br>
                        1. Image Files:
                        ...
                        3. File Integrity:
                            ...
                            form of alteration that may affect their authenticity or readability.</p></div>
                </div>
                <div id="uploadFiles">
                    <fieldset><legend>Image</legend>
                    <input type="file" name="uploadImage" class="inputform"></fieldset>
                    <fieldset><legend>Memorandum of Agreement</legend>
                    <input type="file" name="uploadMOA" class="inputform"></fieldset>
                    <fieldset><legend>Endorsement Letter</legend>
                    <input type="file" name="uploadEndorsement" class="inputform"></fieldset>
                    <fieldset><legend>NBI Clearance</legend>
                    <input type="file" name="uploadNBI" class="inputform"></fieldset>
                </div>
            </div>
            <!--Button-->
          <div id="button-forms">
