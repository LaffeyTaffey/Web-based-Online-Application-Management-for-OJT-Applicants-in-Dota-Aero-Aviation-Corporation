...
<body>
    <main class="container">
        ...
        <div class="topbar">
            <h1 class="current">Admin Profile Settings</h1>
            <span class="search">
        ...
        <script>
            $(document).ready(function () {
                    ...
                    $('.remove-picture').on('click', function (e) {
                        e.preventDefault();
                        // Handle the picture removal here
                    });
                });
        </script>
        ...
        <div class="dashboard">
            <div class="cardcolumn" style="text-align: center">
                <div class="card" style="text-align: center">
                    <div class="avatar">
                        <img class="thumb" src="https://avatars.githubusercontent.com/u/34617016?v=4" width="60" />
                        <h2 id="name">Dito lagay name</h2>
                        <br><br><br>
                        <div class="profile_img_ctrls">
                            <a href="#" class="change-picture"><i class="fa fa-pencil"></i> Change Picture</a>
                            <a href="#" class="remove-picture"><i class="fa fa-trash"></i> Remove Picture</a>
