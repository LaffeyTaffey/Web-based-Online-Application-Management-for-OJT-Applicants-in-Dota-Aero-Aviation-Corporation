    ...
    <main class="container">
        <div class="menu">
            ...
            <nav class="primary">
                ...
                <a href="admin-ojt-results.html#ref" class="menu-item">
        ...
        <div class="topbar">
            <h1 class="current">Check OJT Ref#</h1>
            <span class="search">
        ...
        <div class="dashboard" id="ref">
            <div class="cardcolumn" style="text-align: center">
                <div class="card" style="text-align: center">
            <h2>Search the OJT's reference number</h2>
            </div>
        </div> 
        </div>
        <div class="search-wrapper">
            ...
            <p><!--put image here after search--></p>
        </div>
        <div class="side">
            ...
            <div class="card">
                ...
                <div class="content">
                    <ul>
                        <li>(15:30) results.html ojt applicants can type their reference number and search if accepted or not,
