...
<body>
    <main class="container">
        ...
        <div class="dashboard" id="admdash">
        ...
        <div class="side">
            ...
            <div class="card">
                ...
                <div class="content">
                    <ul>
                        <li>(15:30) results.html ojt applicants can type their reference number and search if accepted or not, if yes, appointment will pop up and they
                        can now log in to their portal) -me, and sayago will display results (img) </li>
                        <li>(18:00) Portal HREF nav -assigned sayago, check first if the user is logged, if its, go to index.html dashboard and if not, go
    ...
    <div class="video">
        <!--video<video src="public/assets/img/videos/i0aze.mp4" muted playinline autoplay loop></video>-->
       <!--to be edited <video
