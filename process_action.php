...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($action == 'approve') {
        ...
        if ($row = mysqli_fetch_assoc($result)) {
            ...
            $emailBody = "<div style='font-family: Arial, sans-serif;'>";
            $emailBody .= "<h2 style='color: #004b87;'>Dear, $firstName $middleName $lastName</h2>";
            $emailBody .= "<p>We regret to inform that your application (ID: $applicantID) Reference Number: OJT24_$applicantID has been disapproved. Please find below the details:</p>";
            $emailBody .= "<li><strong>Status:</strong> <span style='color: red;'>Disapproved</span></li>";
            $emailBody .= "<li><strong>Applicant Email:</strong> $applicantEmail</li>";
            $emailBody .= "<li><strong>Applicant ID:</strong> $applicantID</li>";
            $emailBody .= "<li><strong>Reference Number:</strong> <p>OJT24_$applicantID</p></li>";
