...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['send_email'])) {
    ...
    if ($email_type == 'approved') {
        $mail->Subject = "Request OJT Information Approved";
        $mail->Body = "<p>Dear {$applicant['FirstName']} {$applicant['LastName']},</p>
                  <p>We are pleased to inform you that your request for an Edit in your OJT user information has been approved.</p>
        ...
        $mail->Subject = "Request for Edit of OJT Application Disapproved";
        $mail->Body    = "<p>Dear {$applicant['FirstName']} {$applicant['LastName']},</p>
                  <p>Your request for an Edit in your OJT user information has been Disapproved.</p>
                  <p><strong>Remarks:</strong></p>
                  <p>{$_POST['email_message']}</p>
                  <p><strong>User & OJT Details</strong></p>
                  <ul>
                  <p><strong>User Details:</strong></p>
                  <li><strong>Reference Number:</strong> <p>OJT24_{$applicant['ID']}</p>{$applicant['ID']}</li>
                      <li><strong>Email:</strong> {$applicant['Email']}</li>
                      <li><strong>School Address:</strong> {$applicant['SchoolAddress']}</li>
                      <li><strong>Degree Program:</strong> {$applicant['DegreeProgram']}</li>
                      <li><strong>Year Level:</strong> {$applicant['YearLevel']}</li>
...
<body class="g-sidenav-show bg-gray-200">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white active bg-gradient-primary" href="Admin_Applicant_OJT_Information.php">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">edit</i>
                        </div>
    ...
    <div class="main-content position-relative max-height-vh-100 h-100">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">OJT</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Info</h6>
                </nav>
            </div>
        </nav>
        <!-- End Navbar -->
        ...
        <div class="container mt-5">
            <h2>Manage Applicant OJT Information</h2>
            <form method="post" action="Admin_Applicant_OJT_Information.php" class="mb-3">
                <div class="mb-3">
            ...
            <br>
            <?php if ($applicant) : ?>
                <form method="post" action="Admin_Applicant_OJT_Information.php">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control" id="total_no" name="total_no" value="<?= $applicant['TotalNo.'] ?>" required>
                        </div>
                        <div class="col-md-4">
                            <label for="area_intern" class="form-label">Area Intern</label>
                            <input type="text" class="form-control" id="area_intern" name="area_intern" value="<?= $applicant['Area_intern'] ?>" required>
                        </div>
                        <div class="col-md-4">
                            <label for="start_date" class="form-label">Start Date</label>
                            <input type="date" class="form-control" id="start_date" name="start_date" value="<?= $applicant['StartDate'] ?>" required>
                        </div>
                        <div class="col-md-4">
                            <label for="finish_date" class="form-label">Finish Date</label>
                            <input type="date" class="form-control" id="finish_date" name="finish_date" value="<?= $applicant['Finish_date'] ?>" required>
                        </div>
                    </div>
                    <br>
