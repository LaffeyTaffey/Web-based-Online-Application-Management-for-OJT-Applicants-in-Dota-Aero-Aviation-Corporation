...
<div class="box">
    ...
    <div class="box-info">
        ...
        <a href="forgot-password.html"><button onclick="" class="b-support" title="Forgot Password?"> Forgot Password?</button></a>
        <a href="ticket.html"><button onclick="" class="b-support" title="Contact Support"> Contact Support</button></a>
        <div class="line-wh"></div>
        <a href="landing.html#ojt-adm"><button onclick="" class="b-cta" title="Sign up now!"> REGISTER</button>
    </a></div>
</div>
<br>
</main>
